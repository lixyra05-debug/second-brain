...
*Rien pour l'instant.* Codex lit nativement `AGENTS.md` — section réservée aux particularités (mémoire, commandes) le jour où un agent Codex opérera dans le vault.
